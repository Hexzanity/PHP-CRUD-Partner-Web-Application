...
$sql = "SELECT product_id, Item, Price, Stocks, Size, colors FROM products WHERE product_id = 4";
...
if (mysqli_num_rows($result) > 0) {
    ...
    <div class="col mb-5">
        <div class="card h-100">
            ...
            <img class="card-img-top" src="Shoes4.jpg" width="450" height="300" alt="..."/>
...
?>
    ...
    echo "No product found with ID = 4";
}
