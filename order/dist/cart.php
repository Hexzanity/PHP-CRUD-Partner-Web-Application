                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="update_cart.php">
                                ...
                                <input type="number" name="quantity" value="<?php echo $item_quantity; ?>" min="1" class="form-control" style="width: 50px; margin-right: 10px" pattern="\d+" title="Please enter numbers only">
