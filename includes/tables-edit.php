...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    $query = "UPDATE products SET Item='$item', colors='$color', Size='$size', Price='$price', Stocks='$stocks' WHERE product_id=$id";
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <select class="form-control" id="color" name="color" style="background-color: white; text-align: center;">
        <?php
            $query = 'SELECT DISTINCT colors FROM products';
$result = mysqli_query($db, $query);

$validColors = ['R/W', 'B/W', 'White', 'Br/W', 'Bl/W', 'Blue', 'Coral Green', 'Navy Blue', 'Black /Pink'];
